/*
 * @Author: 陶福.atufo 
 * @Date: 2019-09-11 16:22:05 
 * @Last Modified by: 陶福.atufo
 * @Last Modified time: 2019-10-09 20:20:26
 */
#include <iostream>
#include <cstdlib>
using namespace std;
...
void charTobigNum(bigNum *b);                                     //字符串转大数
...
void bigNum_addToHead(bigNum *b, int x)
{
    num *head = b->head;
    num *newNum = (num *)malloc(sizeof(num));
    newNum->x = x;
